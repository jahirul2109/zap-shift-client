      ...
      <div className="drawer-side is-drawer-close:overflow-visible">
        ...
        <div className="flex min-h-full flex-col items-start bg-base-200 is-drawer-close:w-14 is-drawer-open:w-64">
          ...
          <ul className="menu w-full grow">
            ...
            {/* List item */}
            <li>
              <NavLink to="/dashboard/my-parcel" className="is-drawer-close:tooltip is-drawer-close:tooltip-right" data-tip="My Parcel">
                {/* Parcel icon */}
                <BsBox />
            ...
            <li>
              <NavLink to="/dashboard/rider-approver" className="is-drawer-close:tooltip is-drawer-close:tooltip-right" data-tip="Riders Approval">
                {/* Parcel icon */}
                {/* <FaUsersBetweenLines /> */}
                <MdDirectionsBike />
