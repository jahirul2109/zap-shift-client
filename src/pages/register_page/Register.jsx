    ...
    return (
        <div className="w-8/12 mx-auto pt-10 md:pt-10 space-y-4">
            ...
            <fieldset className="fieldset">
                ...
                <button className="btn btn-primary text-xl mt-4 w-full text-secondary font-semibold ">Register</button>
                <p>Already Have An Account ?<Link to='/login' className='underline text-primary font-semibold'>Loging</Link></p>
            </fieldset>
