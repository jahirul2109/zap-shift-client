...
const Merchant = () => {
  return (
    <div className='relative bg-secondary rounded-2xl md:px-15 md:py-15 py-7 my-10 overflow-hidden px-8'>
      ...
      <p className='text-base-content'>We offer the lowest delivery charge with the highest value along with 100% safety of your product. Pathao courier delivers your parcels in every corner of Bangladesh right on time.</p>
