...
const promised = fetch('/reviews.json').then(res => res.json());
const Review = () => {
  return (
    <div className='my-5 md:my-10'>
      <div className='flex flex-col gap-5 items-center text-center my-5 md:my-10 md:w-8/12 mx-auto'>
        ...
        <p className='text-base-content text-center'>Enhance posture, mobility, and well-being effortlessly with Posture Pro. Achieve proper alignment, reduce pain, and strengthen your body with ease!</p>
      </div>
      <div>
